...
// EndpointParameters represent internal TelcoEndpointParameters
type EndpointParameters struct {
	params *C.TelcoEndpointParameters
}
...
func NewEndpointParameters(params *EParams) (*EndpointParameters, error) {
	...
	var authService *C.TelcoAuthenticationService = nil
	...
	if params.Token != "" {
		...
		authService = (*C.TelcoAuthenticationService)(C.telco_static_authentication_service_new(tknC))
	} else if params.AuthenticationCallback != nil {
		authService = (*C.TelcoAuthenticationService)(C.telco_go_authentication_service_new(unsafe.Pointer(&params.AuthenticationCallback)))
	}
	...
	ret := C.telco_endpoint_parameters_new(
		addrC,
...
func (e *EndpointParameters) SetAssetRoot(assetPath string) {
	...
	C.telco_endpoint_parameters_set_asset_root(e.params, assetRoot)
}

// Clean will clean the resources held by the endpoint parameters.
func (e *EndpointParameters) Clean() {
	clean(unsafe.Pointer(e.params), unrefTelco)
}
