...
func NewRelay(address, username, password string, kind RelayKind) *Relay {
	...
	knd := C.TelcoRelayKind(kind)

	rly := C.telco_relay_new(
		addressC,
		usernameC,
		passwordC,
		knd)
