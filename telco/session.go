...
func (s *Session) IsDetached() bool {
	detached := C.telco_session_is_detached(s.s)
...
func (s *Session) Detach() error {
	var err *C.GError
	C.telco_session_detach_sync(s.s, nil, &err)
	if err != nil {
		return &FError{err}
	}
	return nil
...
func (s *Session) Resume() error {
	var err *C.GError
	C.telco_session_resume_sync(s.s, nil, &err)
	if err != nil {
		return &FError{err}
	}
	return nil
...
func (s *Session) EnableChildGating() error {
	var err *C.GError
	C.telco_session_enable_child_gating_sync(s.s, nil, &err)
	if err != nil {
		return &FError{err}
	}
...
func (s *Session) DisableChildGating() error {
	var err *C.GError
	C.telco_session_disable_child_gating_sync(s.s, nil, &err)
	if err != nil {
		return &FError{err}
	}
...
func (s *Session) CreateScriptBytes(script []byte, opts *ScriptOptions) (*Script, error) {
	...
	if opts == nil {
		opts = NewScriptOptions("telco-go")
	}
	defer clean(unsafe.Pointer(opts.opts), unrefTelco)

	var err *C.GError
	sc := C.telco_session_create_script_from_bytes_sync(s.s,
		bts,
		opts.opts,
		nil,
		&err)
...
func (s *Session) CreateScriptWithOptions(script string, opts *ScriptOptions) (*Script, error) {
	...
	if opts.Name() == "" {
		opts.SetName("telco-go")
	}

	var err *C.GError
	cScript := C.telco_session_create_script_sync(s.s, sc, opts.opts, nil, &err)
	if err != nil {
		return nil, &FError{err}
	}
	return &Script{
...
func (s *Session) CompileScript(script string, opts *ScriptOptions) ([]byte, error) {
	...
	var err *C.GError
	bts := C.telco_session_compile_script_sync(s.s,
		scriptC,
		opts.opts,
		nil,
		&err)
...
func (s *Session) SnapshotScript(embedScript string, snapshotOpts *SnapshotOptions) ([]byte, error) {
	...
	var err *C.GError
	ret := C.telco_session_snapshot_script_sync(
		s.s,
		embedScriptC,
		snapshotOpts.opts,
		nil,
...
func (s *Session) SetupPeerConnection(opts *PeerOptions) error {
	var err *C.GError
	C.telco_session_setup_peer_connection_sync(s.s, opts.opts, nil, &err)
	if err != nil {
		return &FError{err}
	}
	return nil
...
func (s *Session) JoinPortal(address string, opts *PortalOptions) (*PortalMembership, error) {
	...
	var err *C.GError
	mem := C.telco_session_join_portal_sync(s.s, addrC, opts.opts, nil, &err)
	if err != nil {
		return nil, &FError{err}
	}
...
func (s *Session) Clean() {
	clean(unsafe.Pointer(s.s), unrefTelco)
}
...
//   - "detached" with callback as func(reason telco.SessionDetachReason, crash *telco.Crash) {}
