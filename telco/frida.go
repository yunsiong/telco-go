// Package telco provides Go bindings for telco.
...
/*
#cgo LDFLAGS: -ltelco-core -lm -ldl
...
// Version returns currently used telco version
func Version() string {
	return C.GoString(C.telco_version_string())
}
