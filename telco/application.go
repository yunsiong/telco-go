...
func (a *Application) Params() map[string]any {
	ht := C.telco_application_get_parameters(a.application)
...
func (a *Application) Clean() {
	clean(unsafe.Pointer(a.application), unrefTelco)
}
