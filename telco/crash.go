...
// Crash represents crash of telco.
type Crash struct {
	crash *C.TelcoCrash
}
...
func (c *Crash) PID() int {
	if c.crash != nil {
		return int(C.telco_crash_get_pid(c.crash))
	}
	return -1
}
...
func (c *Crash) ProcessName() string {
	if c.crash != nil {
		return C.GoString(C.telco_crash_get_process_name(c.crash))
	}
	return ""
}
...
func (c *Crash) Summary() string {
	if c.crash != nil {
		return C.GoString(C.telco_crash_get_summary(c.crash))
	}
	return ""
}
...
func (c *Crash) Report() string {
	if c.crash != nil {
		return C.GoString(C.telco_crash_get_report(c.crash))
	}
	return ""
}
...
func (c *Crash) Params() map[string]any {
	if c.crash != nil {
		ht := C.telco_crash_get_parameters(c.crash)
...
func (c *Crash) String() string {
	if c.crash != nil {
		return fmt.Sprintf("<TelcoCrash>: <%p>", c.crash)
	}
	return ""
}
...
func (c *Crash) Clean() {
	if c.crash != nil {
		clean(unsafe.Pointer(c.crash), unrefTelco)
	}
}
